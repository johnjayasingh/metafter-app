...
echo "  3. Click '+' and select build/ios/ipa/metafter.ipa"
...
echo "  • Command line: xcrun altool --upload-app --type ios -f build/ios/ipa/metafter.ipa --apiKey YOUR_API_KEY --apiIssuer YOUR_ISSUER_ID"
