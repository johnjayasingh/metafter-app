...
echo "  2. Drag and drop: build/ios/ipa/digitalwill.ipa"
echo "  3. Or use command: xcrun altool --upload-app --type ios -f build/ios/ipa/digitalwill.ipa --apiKey YOUR_API_KEY --apiIssuer YOUR_ISSUER_ID"
echo ""
echo "⚠️  Make sure you have created an app entry in App Store Connect for bundle ID: com.nydco.digitalwill.uat"
