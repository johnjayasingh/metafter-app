...
/// AHD Victoria Step 2 — Your health conditions and concerns
///
/// API field: health_conditions.major_health_conditions
class AhdStep2VicScreen extends StatefulWidget {
  final AhdFlowData flowData;

  const AhdStep2VicScreen({super.key, required this.flowData});

  @override
  State<AhdStep2VicScreen> createState() => _AhdStep2VicScreenState();
}

class _AhdStep2VicScreenState extends State<AhdStep2VicScreen> {
