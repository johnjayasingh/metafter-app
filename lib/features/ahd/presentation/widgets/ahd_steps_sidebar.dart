...
class AhdStepsSidebar extends StatelessWidget {
  final int currentStep;
  final String? userState;

  const AhdStepsSidebar({
    super.key,
    required this.currentStep,
    this.userState,
  });

  List<_AhdStep> get _steps {
    final config = AhdFlowConfig.forState(userState);
    return config.steps
        .map((def) => _AhdStep(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Complete the steps to create your advance health directive.',
