...
class AddLiabilityScreen extends StatefulWidget {
  ...
  const AddLiabilityScreen({super.key, this.existingItem});
...
class _AddLiabilityScreenState extends State<AddLiabilityScreen> {
  ...
  void initState() {
    ...
    if (_isEditing) {
      final data = widget.existingItem!.liabilityData;
      ...
      final mock = DebugDataService.debugVaultLiabilityData;
      _nameController.text = mock['name'] ?? '';
      _detailController.text = mock['detail'] ?? '';
  ...
  void _onSave() {
    ...
    if (_selectedAssetType == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please select a liability type')),
      );
      return;
    }
    ...
    final liabilityData = LiabilityData(
    ...
    final payload = VaultItemCreate(
      ...
      type: VaultAssetType.liability,
      data: liabilityData.toMap(),
    );
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            _isEditing ? 'Edit Liability' : 'Liabilities - Add',
    ...
    return InputDecorator(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<AssetTypeItem>(
          ...
          hint:
              Text('Select liability type', style: AppTextStyles.inputHint),
          isExpanded: true,
